      ...
      <div className="container">
        ...
        <div className="about-grid">
          <div className="about-content">
            ...
            <p className="about-text" style={{ marginTop: '2rem', fontWeight: '600' }}>
              Mission
            </p>

            <p className="about-text">
              To integrate contemporary art into everyday life and conscious collecting, fostering trust between artists, collectors, and audiences.
            </p>

            <p className="about-text">
              Based in Almaty, Begilda Gallery works with collectors and institutions worldwide.
            </p>
          </div>
        </div>
      </div>
